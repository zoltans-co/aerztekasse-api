...
import ch.zoltans.aerztekasse.api.aerztekasseapi.places.dtos.PlacesDTO;
import ch.zoltans.aerztekasse.api.aerztekasseapi.places.entities.Place;
import ch.zoltans.aerztekasse.api.aerztekasseapi.services.PlacesService;
...
public class PlacesController {
  ...
  @Operation(
      ...
      description = "Add a new place and persist it in the database")
  ...
  public PlacesDTO getAllPlacesDTO() {
    return placesService.getAllPlacesDTO();
  }
